...
describe('RestoreNotificationHelper', () => {
    test('getFailedRestoreNotification', () => {
        const { getFailedRestoreNotification } = (0, RestoreNotificationHelper_1.default)();
        const redirectfn = () => { };
        const closefn = () => { };
        const notification = getFailedRestoreNotification(documentsData, documentsData.collection[0], redirectfn, closefn);
        ...
        expect(args.message.props.failed).toBe(true);
...
//# sourceMappingURL=FailedRestoreNotificationHelper.spec.js.map
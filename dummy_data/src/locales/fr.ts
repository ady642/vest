const fr: Record<string, unknown> = {
  ged: {
    ...
    trash: {
      title: 'Corbeille',
      recentDelete:
        "Ici, accédez à l'ensemble de vos documents récemment supprimés",
      arboCard: {
        title: 'Corbeille',
...
Vous pouvez les restaurer ou les archiver.`
      ...
      restore: {
        confirmation: {
          ...
          description:
            'Si vous cliquez sur continuer, le document sélectionné sera restauré.'
        },
        successPopup: {
        ...
        failedPopup: {
          ...
          content:
            'Un probléme est survenu durant la restauration de votre document veuillez réessayer plus tard'
        },
        inProgressPopup: {
          content:
            'Restauration en cours | Restauration en cours | Restaurations en cours'
        },
        error:
          'Un problème est survenu durant la restauration du documents, merci de réessayer plus tard.'
      }
    },
    dataManipulation: {
      mailtoged: {
      ...
      delete: {
        ...
        modal: {
          title:
            'Êtes-vous sûr de vouloir supprimer ce fichier ? | Êtes-vous sûr de vouloir supprimer ces { fileCount } fichiers ?',
      ...
      mailToGed: {
        Modal: {
          ...
          description:
            'Déposez vos documents à vos experts KPMG en les envoyant aux adresses emails suivantes',
    ...
    drawer: {
      ...
      downloadTab: {
        description: {
          ...
          part2:
            'Ce statut vous permet de vous séparer de la pièce comptable originale papier en toute sérénité'
        },

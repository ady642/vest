...
describe('RestoreNotificationHelper', () => {
    test('getPendingRestoreNotification', () => {
        const { getPendingRestoreNotification } = (0, RestoreNotificationHelper_1.default)();
        const redirectfn = () => { };
        const closefn = () => { };
        const notification = getPendingRestoreNotification(documentsData, documentsData.collection[0], redirectfn, closefn);
...
//# sourceMappingURL=PendingRestoreNotificationHelper.spec.js.map
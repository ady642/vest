...
import { UploadFileInfoTypeWrapper } from 'dummy_data/tests/unit/src/modules/DataManipulation/Upload/components/DocumentsModalUpload/Content/UploadFileInfo.spec'

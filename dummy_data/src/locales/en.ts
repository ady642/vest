...
Vous pouvez les restaurer ou les archiver.`
      ...
      restore: {
        confirmation: {
          ...
          description:
            'If you click continue then the selected document will be restored.'
        },
        successPopup: {
        ...
        failedPopup: {
          ...
          content:
            'A problem occurred during the restoration of your document please try again later.'
        },
        inProgressPopup: {
          content:
            'Restoration in progress | Restoration in progress | Restorations in progress'
        },
        error:
          'A problem occurred during the restoration of your document please try again later.'
      }
    ...
    dataManipulation: {
      ...
      delete: {
        ...
        modal: {
          title:
            'Are you sure you want to delete this file? Are you sure you want to delete these { fileCount } files?',
      ...
      mailToGed: {
        Modal: {
          ...
          description:
            'Drop your documents to your KPMG experts by sending them to the following email addresses',
          knowMore: 'Learn more',
          buttons: {
            close: 'Close',
    ...
    drawer: {
      ...
      downloadTab: {
        description: {
          ...
          part2:
            'This status allows you to part with the original paper accounting document with peace of mind'
        },
        date: ' Date of issue',
